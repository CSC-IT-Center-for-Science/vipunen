...
TRUNCATE TABLE VIPUNEN_DW.dbo.f_amk_talous_3_kulut_ja_tuotot
...
SELECT d1.id AS d_amk_id
  ...
  FROM VIPUNEN_SA.dbo.SA_SUORAT_AMK_TALOUS_3_tuloslaskelman_toiminnot f
  INNER JOIN VIPUNEN_DW.dbo.d_amk d1 ON f.AMK_koodi = d1.amk_tunnus
  INNER JOIN VIPUNEN_DW.dbo.d_toiminto d2 ON f.PTTOIMINTO = d2.toiminto